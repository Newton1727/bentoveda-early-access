export default function GlobalLine() {
  return (
    <section className="relative px-6 py-20 bg-gradient-to-br from-slate-950 via-slate-900 to-slate-950">
              ...
              <div className="space-y-4">
                <div className="flex items-start gap-4">
                  ...
                  <p className="text-lg text-slate-300">
                    Modern, globally inspired nutrition formats
                  </p>
                </div>
